...
|**[Spiderfoot](https://github.com/smicallef/spiderfoot)** |This package contains an open source intelligence (OSINT) automation tool. Its goal is to automate the process of gathering intelligence about a given target, which may be an IP address, domain name, hostname, network subnet, ASN, e-mail address or person’s name. | <img src="https://www.kali.org/tools/spiderfoot/images/spiderfoot-logo.svg" width="100"/> |
